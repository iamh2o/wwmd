...
| UX-001 | Native product | Collection health, pause, summaries, drill-down, and association correction views | IN_PROGRESS | feature_implementation | Gate 5 | root | Sources/WWMDApp/main.swift menu-bar/viewer scaffold | UI is not yet connected to signed agent XPC or real projected summaries | Visible development state/privacy boundary is implemented; functional views remain. |
